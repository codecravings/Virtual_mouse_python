...
def left_click_delay():
    global l_delay
    global left_click_thread
    time.sleep(1)
    l_delay = 0
    left_click_thread = threading.Thread(target=left_click_delay)

def right_click_delay():
    global r_delay
    global right_click_thread
    time.sleep(1)
    r_delay = 0
    right_click_thread = threading.Thread(target=right_click_delay)
